...
import com.willychia.gdvolley_b_0820.adapters.MahasiwaAdapter
    ...
    private fun allMahasiwa() {
        ...
        val stringRequest: StringRequest = object :
            StringRequest(Method.GET, MahasiswaApi.GET_ALL_URL, Response.Listener { response ->
                val gson = Gson()
                var mahasiswa : Array<Mahasiswa> = gson.fromJson(/* json = */ response, /* classOfT = */
                    Array<Mahasiswa>::class.java)
